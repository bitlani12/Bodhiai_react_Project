...
import DetailedExpansionPanel from './progressheader';
...
recievedate= (date) => {
  ...
  buttonshow = () => {
    this.setState(this.setState({optionshow:true}))
  }
  render() {
   ...
   < DetailedExpansionPanel recievedate = {this.recievedate}/>
...
<Col style={{margin:10}}> </Col>
            <Col>
            {this.state.optionshow === false ? "" : <div><button >Institue Analysis</button><button> Online Analysis</button> </div>}
            </Col>
...
export default connect(mapStateToProps , { fetchMyProgressData  })(Typography);