                            ...
                            <Grid container>
                              ...
                              >
                                ...
                                <Card
                                  ...
                                  onClick={() =>
                                    this.props.buttonsubject(val[0])
                                  }
                                  key={i}
        ...
        {this.state.optionshow === false ? (
          ...
          <div className="text-center">
            ...
            >
              ...
              {this.props.fetched ? (
                /*<SelectDate date={this.props.date} dateselected={this.dateselected}/> */ "this is click"
              ) : (
                <h3>
                  <Loading />
                </h3>
          ...
          <div className="text-center">
            ...
            >
              {this.props.loadafterdateselect === false ? (
                /*<Performancedata data={this.props.performancedata} dateselected={this.dateselected} fetched={this.props.fetchedperformancedata}/>  */ "this is click"
              ) : (
                <Loading />
              )}
            </Animated>
